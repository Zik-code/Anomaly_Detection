...
class TransformerEncoderLayer(nn.Module):
    def __init__(self, d_model, nhead, dim_feedforward=16, dropout=0):
        ...
        self.att = None # 这行是DTAAD相比TranAD增加的
    ...
    def forward(self, src, src_mask=None, src_key_padding_mask=None, is_causal: bool = None):
        src2 = self.self_attn(src, src, src)[0]
        self.att = self.self_attn(src, src, src)[1] # 这行是DTAAD相比TranAD增加的
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_mask=None, memory_mask=None, tgt_key_padding_mask=None,
                memory_key_padding_mask=None, is_causal: bool = None):
